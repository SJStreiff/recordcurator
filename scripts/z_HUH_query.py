...
CONTAINS:
    ...
    get_huh():
        function to search best match on HUH botanists index, based on a name in the format Surname, FM (first and mid name in initials)

    huh_wrapper():
        applies the get_huh() function to a larger dataframe. Swifter apply to make it a bit faster
